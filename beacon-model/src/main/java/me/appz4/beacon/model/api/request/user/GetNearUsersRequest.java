...
public class GetNearUsersRequest extends ApiRequestWithToken implements IRequestValidator {
    ...
    public String toString() {
        return "GetNearUsersRequest [center=" + this.center + ", northEast=" + this.northEast + ", southWest=" + this.southWest + "]";
    }
